...
<title>PARFIT 전시 안내 & 감정-컬러 가이드</title>
<style>
  :root{
    --bg:#0b0b10; --card:#14141c; --muted:#9aa3b2; --text:#e9ecf1; --accent:#62e0c8;
    --radius:18px;
  }
  *{box-sizing:border-box}
  body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Apple SD Gothic Neo,Noto Sans KR,sans-serif;color:var(--text);background:radial-gradient(1200px 600px at 85% -10%, #1e2954 0, rgba(30,41,84,0) 60%),var(--bg)}
  ...
  .badge{padding:6px 10px;border:1px solid #303848;border-radius:999px;color:var(--muted);font-size:12px}
  .card{background:linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.02));border:1px solid #2a3140;border-radius:var(--radius);padding:20px}
  ...
  .step{display:flex;gap:12px;align-items:flex-start;background:rgba(255,255,255,0.03);border:1px solid #2a3140;border-radius:14px;padding:12px}
  .step .num{flex:0 0 26px;height:26px;border-radius:8px;background:#202838;color:#dfe6ef;display:grid;place-items:center;font-weight:700}
    ...
    <div class="grid">
      ...
      <section class="card">
        ...
        <div class="table">
          ...
          <div class="chip"><span class="emoji">😢</span>슬픔 </div>
          <div class="swatch">
